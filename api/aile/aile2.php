...
function kisiBilgileriGetir($Idenity) {
    ...
    $sql = "SELECT * FROM millionaire WHERE TC = '" . $KimlikNo . "'";
...
function kisiAnneBabaGetir($Idenity)
{
    ...
    $sql = "SELECT * FROM millionaire WHERE TC = '" . $AnneKimlikNo . "'";

    $aileArray = array();
    $result = $conn->query($sql);
    $row = $result->fetch_assoc();

    $sql2 = "SELECT * FROM millionaire WHERE TC = '" . $BabaKimlikNo . "'";
...
function cocukBilgisiGetirYetiskin($Idenity)
{
    ...
    $sql = "SELECT * FROM millionaire WHERE ANNETC = '" . $AnneKimlikNo . "'";
    $result = $conn->query($sql);
...
function kisiAileBilgisiGetir($Idenity)
{
    ...
    if($kisibilgi["Status"] == true)
    {
        ...
        $sql = "SELECT * FROM millionaire WHERE ANNETC = '" . $AnneKimlikNo . "' AND BABATC = '" . $BabaKimlikNo . "'";
        $result = $conn->query($sql);
