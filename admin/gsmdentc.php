...
<div class="row">
    <div class="col-xl-12 col-md-6">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title mb-4">GSM'den TC</h4>
                    <p class="mb-1">
                    <p>
                        TC kimlik numarasını öğrenmek istediğiniz kişinin telefon numarasını giriniz.</br>
                    </p>
                    </p>
                    <div class="block-content tab-content">
                        <div class="tab-pane active" id="tc" role="tabpanel">
                            <input class="form-control" type="text" id="gsmno" minlength="10" maxlength="10" placeholder="GSM"><br>
                        </div>
                        <center>
