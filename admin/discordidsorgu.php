...
<div class="container" id="main_container">
	...
	<input class="form-control" id="text" placeholder="Discord ID" type="number" maxlength="19" required><br>
	 <button onclick="encodeString()" id="sorgula" name="yolla" class="btn btn-outline-primary btn-border" style="width: 180px; height: 45px; outline: none; margin-left: 5px;"><span><i class="fas fa-search"></i> Sorgula <span id="sorgulanumber"></span></span></button>
	 <script>
